...
- [#](#制作-arch-live) 制作 Arch Live

首先下载新[镜像open in new window](https://archlinux.org/download/)。
...
### [#](#_1-挂载分区并生成-fstab) 1\. 挂载分区并生成 fstab
...
若后续启用 [swapopen in new window](https://wiki.archlinux.org/title/Swap_(%E7%AE%80%E4%BD%93%E4%B8%AD%E6%96%87))，则再执行 `genfstab` 即可。
...
[编辑文档！ open in new window](https://github.com/shanyuhai123/documents/edit/master/docs/os/arch/archlinux-system-migration.md)

上次更新: 2022/9/12 21:40:37

贡献者: shanyuhai123

[Arch 神教](/os/arch/) [支持 emoji](/os/arch/arch-support-emoji.html)
